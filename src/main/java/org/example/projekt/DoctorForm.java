...
public class DoctorForm {
     ...
     * @param doctorToEdit lekarz do edycji, jeśli null - tworzenie nowego
     * @param onSave akcja do wykonania po zatwierdzeniu formularza
     */
    public static void showForm(Doctor doctorToEdit, Consumer<Doctor> onSave) {
        ...
        grid.add(new Label("Imię:"), 0, 0); grid.add(firstName, 1, 0);
        grid.add(new Label("Nazwisko:"), 0, 1); grid.add(lastName, 1, 1);
        grid.add(new Label("Specjalizacja:"), 0, 2); grid.add(spec, 1, 2);
        grid.add(new Label("Sala:"), 0, 3); grid.add(room, 1, 3);
        grid.add(new Label("Kontakt:"), 0, 4); grid.add(contact, 1, 4);
        grid.add(new Label("Wiek:"), 0, 5); grid.add(age, 1, 5);
        grid.add(new Label("Pesel:"), 0, 6); grid.add(pesel, 1, 6);
